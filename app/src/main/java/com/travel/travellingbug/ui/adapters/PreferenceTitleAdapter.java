...
public class PreferenceTitleAdapter extends RecyclerView.Adapter<PreferenceTitleAdapter.ViewHolder> {

    Context context;
    ArrayList<VerifyIdMainActivityModel> list;

    public PreferenceTitleAdapter(Context context, ArrayList<VerifyIdMainActivityModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        try {
            ...
            Picasso.get().load(verifyIdMainActivityModel.getNotAllowed()).placeholder(R.drawable.ic_dummy_user).error(R.drawable.ic_dummy_user).into(holder.notAllowed);
