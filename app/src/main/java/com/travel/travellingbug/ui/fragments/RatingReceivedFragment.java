...
public class RatingReceivedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rating_received, container, false);

        initData(view);

        user_id = SharedHelper.getKey(getContext(), "id");
