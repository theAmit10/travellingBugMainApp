...
public class VehicleDetailsTypeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service_type = SharedHelper.getKey(getApplicationContext(), "service_type");
    ...
    public void getVehicle() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URLHelper.VEHICEL_UPDATE, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(VehicleDetailsTypeActivity.this, "Error Found", Toast.LENGTH_SHORT).show();
            ...
            public Map<String, String> getParams() {
                ...
                params.put("attributetype", "vehicletype");
