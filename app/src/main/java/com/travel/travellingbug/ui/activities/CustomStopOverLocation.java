...
public class CustomStopOverLocation extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_stop_over_location);
                            ...
                            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, getPlaceAutoCompleteUrl(txtDestination.getText().toString()), object, new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    if (mAutoCompleteAdapter == null) {
                                        ...
                                        mAutoCompleteAdapter = new AutoCompleteAdapter(CustomStopOverLocation.this, predictions.getPlaces(), CustomStopOverLocation.this);
